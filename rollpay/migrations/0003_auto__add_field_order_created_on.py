...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.created_on'
        db.add_column(u'rollpay_order', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 9, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.created_on'
        db.delete_column(u'rollpay_order', 'created_on')
    ...
    models = {
        ...
        u'rollpay.order': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
